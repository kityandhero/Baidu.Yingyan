...
{
    /// <summary>
    /// 报警服务端回调 <a href="http://lbsyun.baidu.com/index.php?title=yingyan/api/v3/geofencealarm">详情</a>
    /// </summary>
    /// <seealso cref="CommonResult" />
    public class FenceAlarmCallbackResult
    {
        /// <summary>
        /// 消息类型 取值1或者2 1：当type=1时，校验该URL为有效URL。此时，content为空或不存在。开发者无需对消息内容做任何处理，只需正常返回即可。
